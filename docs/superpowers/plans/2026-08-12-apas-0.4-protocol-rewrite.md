...
- [x] **Step 1: Replace the universal `dispatch/v1` format with the baseline logical statement**
...
- [x] **Step 2: Add a valid generic in-toto Statement JSON example**
...
- [x] **Step 3: Define Event and Evidence-reference fields**
...
- [x] **Step 4: Retain DSSE as the L2+ baseline**
...
- [x] **Step 6: Move existing mechanisms into the ART profile**
...
- [x] **Step 7: Replace the normative hash hierarchy with causal and commitment rules**
...
- [x] **Step 8: Parse every JSON example**
...
- [x] **Step 9: Commit the carrier/profile pass**
...
- [x] **Step 1: Rewrite the threat matrix in core vocabulary**
...
- [x] **Step 2: Preserve threats not addressed**
...
- [x] **Step 3: Rewrite the standards relationship table**
...
- [x] **Step 4: Rewrite the ART reference mapping**
...
- [x] **Step 5: Rewrite the independent validation example anonymously**
...
- [x] **Step 6: Add the original-requirement disposition appendix**
...
- [x] **Step 7: Run the normative-coupling scan**
...
- [x] **Step 8: Commit the security and mapping pass**
...
- [x] **Step 1: Scan for placeholders and stale claims**
...
- [x] **Step 2: Verify section and glossary coverage**
...
- [x] **Step 3: Validate JSON and Mermaid blocks**
...
- [x] **Step 5: Review the final diff against the design disposition audit**
...
- [x] **Step 6: Commit any verification corrections**

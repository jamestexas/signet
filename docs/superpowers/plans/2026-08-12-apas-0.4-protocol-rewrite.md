...
- [ ] **Step 1: Replace version notes, Abstract, Roles, and normative references**
...
- [ ] **Step 2: Rewrite the problem statement using Activity vocabulary**
...
- [ ] **Step 3: Add the protocol architecture and lifecycle diagrams**
...
- [ ] **Step 4: Expand Appendix A into the canonical glossary**
...
- [ ] **Step 5: Run the ontology consistency check**
...
- [ ] **Step 6: Commit the ontology pass**
...
- [ ] **Step 1: Rewrite the conformance reading rule**
...
- [ ] **Step 2: Write L1 — Recorded Agent Activity**
...
- [ ] **Step 3: Write L2 — Authenticated Provenance**
...
- [ ] **Step 4: Write L3 — Independently Appraised Execution**
...
- [ ] **Step 5: Write L4 — Content-complete Reconstruction**
...
- [ ] **Step 6: Preserve and integrate the full origin model**
...
- [ ] **Step 7: Check cumulative and falsifiable wording**
...
- [ ] **Step 8: Commit the assurance pass**
...
Expected: both exit 0. If `task check` fails for an unrelated environmental reason, record the exact command and failure without marking the gate passed.
